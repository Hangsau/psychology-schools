...
next_action: 從 L42 楊中芳生年、學歷、書目與任教經歷開始；逐項記錄來源，重複人物資料亦須有本句可稽核 anchor
...
- **P6 品質穩定化試點**：已啟動，P5 暫停。`claims-schema.json`、`verify-claims.py`、strict 結構模式與 `inventory-high-risk.py` 已完成；CBT／精神分析／本土心理學共登錄 20 條高風險主張（10 corroborated、10 retrieved）。句級高召回盤點共列出 305 個候選單位，19 個句子／條目已有 anchor 覆蓋，286 個仍待人工裁決；三篇均維持 `in_progress`。
