...
2026-07-20 新增 `tools/inventory-high-risk.py`，以日期、數字、人物／理論歸屬、療效、最高級／絕對性語句及 §4 書目條目列出候選單位。它是分流器而非真偽判定器；命中仍須人工裁決，未命中也不能自動證明低風險。清單項目分開計數，claims 只以唯一 exact anchor 視為覆蓋。
